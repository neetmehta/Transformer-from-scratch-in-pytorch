...
from configs.config import TransformerConfig, OverfitConfig
...
def main():
    ...
    for epoch in range(start_epoch, config.num_epochs):
        ...
        if avg_loss < best_loss:
            print(
                f"Saving checkpoint... (loss improved from {best_loss:.4f} to {avg_loss:.4f})"
            )
            save_checkpoint(
